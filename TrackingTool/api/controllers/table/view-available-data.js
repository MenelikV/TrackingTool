module.exports = {
  ...
  fn: async function (inputs, exits) {
     ...
     let vis_headers = ["Aircraft", "MSN", "Flight", "Airline", "Flight Date", "Fuel Flowmeters", "Fuel Characteristics", "Weighing", "Results", "Aircraft Identification", "Airline Tables", "Tabulated Results", "Parameters Validation", "Fleet Follow Up", "TRA", "TRA Comment", "CTR", "Results Status", "Data Validated Status", "Commentary", "Delivery Date"];
